      ...
      <CardHeader className="pb-3">
        ...
        <div className="flex items-start gap-3">
          <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center flex-shrink-0">
            <span className="text-white font-bold text-sm">{getCompanyInitials(job.company.name)}</span>
          </div>

          <div className="flex-1 min-w-0">
            <p className="text-gray-600 font-medium mb-1 line-clamp-1">{job.company.name}</p>
